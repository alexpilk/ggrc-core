...
IMPORT_NEW_WITH_SLUG = (u"Line {line}: There is no object with '{code}' code. "
                        u"A new {object_type} will be created with an "
                        u"autogenerated Code. The Code column will be "
                        u"ignored.")
